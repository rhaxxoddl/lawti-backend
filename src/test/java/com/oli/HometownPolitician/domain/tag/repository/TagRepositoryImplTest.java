...
class TagRepositoryImplTest {
    ...
    private void initialData() {
        ...
        List<Tag> tags = tagRepository.findAll().subList(0, 5);
    ...
    @Test
    @DisplayName("UserUuid로 해당 유저가 followed한 Tags 반환됨을 확인")
    public void qFindFollowedTagsByUserUuid() {
        List<Tag> tags = tagRepository.qFindFollowedTagsByUserUuid(USER_UUID);
